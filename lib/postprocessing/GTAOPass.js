...
class GTAOPass extends Pass {
	...
	overrideVisibility() {
		...
		scene.traverse( function ( object ) {
			...
			// Transparent/cutout effect cards must not enter the normal/depth
			// buffer as opaque geometry. The override material cannot see their
			// alpha maps, so including them produces dark rectangular AO flashes.
			if ( object.isPoints || object.isLine || object.userData.gtaoExcluded ) object.visible = false;
